...
enum Theme {
    enum Spacing {
        ...
        /// Outer inset of Tonycast's dialog content.
    ...
    enum Size {
        ...
        /// Tonycast's own control dialog: fixed width, height measured from its SwiftUI content.
    ...
    /// Motion owned by Tonycast's menus; extension-provided panels keep their own behavior.
    @MainActor
    enum MenuMotion {
    ...
    enum Colors {
        ...
        /// Modal separation inside Tonycast: the launcher recedes while its dialog is in front.
