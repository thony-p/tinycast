...
/// Tonycast's self-description, sent ahead of every message and billed again on every turn.
enum AIPreamble {
    ...
    static let text = """
        ...
        You happen to be built into Tonycast, a native macOS menu-bar launcher and an open-source \
        ...
        Tonycast also provides a fuzzy app launcher, global and per-app hotkeys, clipboard history \
        ...
        Use this only when the user asks about Tonycast. Say so when you do not know rather than \
        inventing a feature, and compare Tonycast with other tools honestly — you are not here to \
