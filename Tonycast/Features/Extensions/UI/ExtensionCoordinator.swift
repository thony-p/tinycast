...
final class ExtensionCoordinator {
            ...
            guard
                await core.confirm(
                    ...
                    message:
                        ...
                        + "holds a JavaScript engine in memory until you leave it — expect Tonycast "
    ...
    func showExtensionSettings(for owner: InstalledExtension) {
        ...
        NotificationCenter.default.post(
            name: .tonycastSelectExtension, object: owner.manifest.name)
    }
...
extension Notification.Name {
    ...
    static let tonycastSelectExtension = Notification.Name("tonycastSelectExtension")
}
