...
final class AppSettings {
    ...
    /// Follow macOS, or pin Tonycast to one appearance. Applied by `AppCore.applyAppearance()`.
    ...
    /// Off by default: connecting a server is consent to run code Tonycast did not write.
    var mcpEnabled: Bool {
    ...
    /// Off out of the box: on means Tonycast may read a selection anywhere and type over it.
    ...
    /// For a toolchain Tonycast doesn't know — mise or Nix shims are the common case.
